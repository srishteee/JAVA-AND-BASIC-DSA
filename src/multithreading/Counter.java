...
public class Counter {
    ...
    public  synchronized  void inrement () {   // this part of section known as critical section before when we are not using synchronised keyword this condition is callled race condiiton in which two thread shared one pobject and outcomes is not predictable
